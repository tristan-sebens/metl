  ...
  setRefClass(
    ...
    fields =
      list(
        ...
        table_metadata_fieldmap = "FieldMap",
    ...
    methods =
      list(
          ...
          function(
            output_fieldmaps =
              list(
                ...
                "table_meta" = ABLTAG_TABLE_METADATA_TABLE_FIELDS,
                "field_meta" = ABLTAG_FIELD_METADATA_TABLE_FIELDS
              ),
            user_input_fieldmap = USER_INPUT_FIELDS,
            table_metadata_fieldmap = AUTOGENERATED_TABLE_METADATA_FIELDS,
            field_metadata_fieldmap = AUTOGENERATED_FIELD_METADATA_FIELDS,
            ...
          ) {
            callSuper(
        ...
        create_table_meta_datamap =
          function() {
            table_metadata =
              data.frame(
                table = sapply(output_fieldmaps, function(fm) fm$table),
                description = sapply(output_fieldmaps, function(fm) fm$description)
              )

            return(
              DataMap(
                input_data_field_map = table_metadata_fieldmap,
                extract_fn =
                  function(d) {
        ...
        expand_data_maps =
          function(meta) {
            ...
            if(!nrow(meta) == 0) {
              ...
              DataMap_UserInput =
                create_user_input_datamap(meta)
        ...
        decode_to_db =
          function(..., con, silent=F, limit=NULL) {
            ...
            DBI::dbWithTransaction(
              ...
              code = {
                ...
                for (data_type in names(decoded_data)) {
                  ...
                  # If requested, limit the number of rows upserted to the DB tables
                  if(!is.null(limit)) {
                    dat = head(dat, limit)
                  }
                  # Perform the upsert
