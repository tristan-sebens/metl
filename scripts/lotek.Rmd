...
```{r}
d = file.path(lotek_data, "LTD 1300-LTD 1000-LTD 1110-LTD 1250", "Sablefish", "1484")
...
dat_t_ = dm_$transform(dat_)
```

```{r}
d2 = file.path(lotek_data, "LTD 1300-LTD 1000-LTD 1110-LTD 1250", "Sablefish", "2485")

dat2_ = dm_$extract(d2)
dat2_t_ = dm_$transform(dat2_)
```
